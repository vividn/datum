...
export function handleDataArgs(args: DataArgs): DatumData {
  ...
  // for occurring data, occurTime generated by handleTimeArgs should be passed along
  // TODO it can influence the relative time for -Time keys
  if (args.occurTime) {
    parsedData.occurTime = args.occurTime;
  }
