describe("datumTimeToLuxon", () => {
  ...
  it.todo("converts a DatumTime with utc, o to a DateTime with the given offset");
  it.todo("converts a DatumTime with utc, tz to a DateTime with the given timezone");
  it.todo(
    "converts a DatumTime with utc, o and tz that match to a DateTime with the given timezone"
  );
  test.todo("if o and tz do not match, warns about it and uses the fixed offset");
});

describe("toDatumTime", () => {
  it.todo("converts a DateTime to a DatumTime with proper utc");
  it.todo("records the hour offset and iana timezone as well for various DateTimes");
  it.todo(
